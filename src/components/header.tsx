...
const Header: React.FC = () => {
  ...
  return (<>
    ...
    <header className="w-full hidden md:block">
      <nav className='flex items-center justify-between px-6 py-3 mx-3 mt-3 rounded-xl bg-gradient-to-r from-black via-black/95 to-black/20 backdrop-blur-sm border border-gray-700/50 shadow-2xl'>
        <div className="logo">
    ...
    {/* Mobile Header - Left Vertical Navbar */}
